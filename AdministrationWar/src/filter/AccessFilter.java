...
import userAdmin.security.Page;
import userAdmin.security.RightsManager;
...
public class AccessFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (pathInfo != null && request.getServletPath().contains("faces")) {
            ...
            if (page != null) {
                ...
                if (u == null) {
                    u = new Siteuser();
                    u.setDroit(rm.toLong(Access.GUEST));
                    request.getSession().setAttribute(Session.UserCo.getName(), u);

                    System.out.println("Création d'une session Utilisateur.");
                }
                ...
                if (u.is(rm.toLong(Access.USER))) {
                    redirectPath = Page.FAppView.getPath();
                } else if (u.has(rm.toLong(Access.MANAGER))) {
                    redirectPath = Page.FAppManage.getPath();
                }
            }
        }
